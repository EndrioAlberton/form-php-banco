...
if (isset($_POST['enviar'])) {
    ...
    $sth = $con->prepare("INSERT INTO formulario(nome, email, idade, regiao, plataforma, rota, comentario)  
                        VALUES(:nome, :email, :idade, :regiao, :plataforma, :rota, :comentario)");
        ...
        <div class="all-form"> 
            <form action="" method="POST" id="form">   
                ...
                <div class="formulario"> <!--8-->  
                        <button type="submit" name="enviar" id="botao" class="submit"> Enviar </button> 
                </div>  
            </form>    
        </div>        
    </div>      
